...
GeospatialDataset* System::openShpGeospatialDataset(const std::string& filename, AccessMode accessMode)
{
	...
	GeospatialDataset* dataset = new GeospatialDataset(filename, true);
