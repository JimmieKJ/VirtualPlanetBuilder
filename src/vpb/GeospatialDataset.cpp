...
GeospatialDataset::GeospatialDataset(const std::string& filename, bool isShpFile)
{
	updateTimeStamp();
	_dataset = (GDALDataset*)GDALOpenEx(filename.c_str(), GDAL_OF_VECTOR, nullptr, nullptr, nullptr);
}
